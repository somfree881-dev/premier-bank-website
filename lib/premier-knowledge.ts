...
- Requirements shown on the website: National ID or Passport; Driver's License as additional identification; Proof of Address such as a recent utility bill or bank statement not older than 3 months; Employment ID or Letter; a valid Work Permit for non-citizens where applicable; and two recent passport-size photos.
...
- Premier Tap is a modern contactless solution for tap payments with supported devices, including a ring and other Premier Tap devices. It is described as fast, convenient, secure and modern.
...
- Premier Mastercard is available for USD 2 and can be used for supported online payments, POS payments, travel, bookings, and international services that accept Mastercard. User-provided official service information says online and POS payments are fee-free. Booking.com and Trip.com are examples of online travel services that accept Mastercard; availability still depends on the merchant accepting Mastercard. A supplied campaign requires at least USD 60 in spending; every additional USD 30 increases the chance of rewards. No campaign dates or further terms are available.
...
- Premier Tap uses NFC contactless payments on supported rings, wristbands, bracelets, key fobs, stickers, smartwatches/NFC-enabled watches, glasses/eyewear and phones. Country-specific availability and campaign terms must not be generalized.
...
- Premier Wallet also supports top-up, wallet-to-wallet transfers by QR code or contact information, bank-account transfers, transfers to an unregistered Wallet recipient, deposits and withdrawals through supported ATMs and agents, balance checking, transaction history, exchange/currency conversion, and financial management. Do not invent limits, fees, currency-pair availability or an undocumented withdrawal process.
...
- Premier Wallet source-provided supported examples include water, education, TV/Cable and healthcare payments; wallet-to-wallet and wallet-to-bank transfers; sending to a recipient without a Wallet; remittances; QR or Merchant ID payments; airtime top-up; in-app currency exchange; and transaction history. Limits, fees, providers and availability may vary and must not be invented.
...
const quickTranslations: Record<ChatLanguage, { current: string; open: string }> = {
  so: {
    ...
    open: "Si aad u bilowdo Personal Current Account, website-ku wuxuu xusaa: National ID ama Passport, Driver's License oo aqoonsi dheeraad ah, caddeynta cinwaanka oo aan ka weynayn saddex bilood, Employment ID ama Letter, work permit qofka aan muwaadin ahayn haddii ay khusayso, iyo laba sawir oo passport-size ah. Wixii hagid gaar ah, fadlan la xiriir Premier Bank.",
  },
  en: {
    ...
    open: "To get started with a Personal Current Account, the website lists: a National ID or Passport, Driver's License as additional identification, proof of address not older than three months, Employment ID or Letter, a work permit for non-citizens where applicable, and two recent passport-size photos. For account-specific guidance, please contact Premier Bank.",
  },
  sw: {
    ...
    open: "Ili kuanza Personal Current Account, tovuti inaorodhesha: National ID au Passport, Driver's License kama kitambulisho cha ziada, uthibitisho wa anwani usiozidi miezi mitatu, Employment ID au Letter, work permit kwa wasio raia inapohitajika, na picha mbili za passport-size za karibuni. Kwa mwongozo wa akaunti yako, tafadhali wasiliana na Premier Bank.",
  },
  am: {
    ...
    open: "Personal Current Account ለመጀመር ድህረ ገጹ የሚዘረዝረው፦ National ID ወይም Passport፣ ተጨማሪ መታወቂያ እንደ Driver's License፣ ከሦስት ወር ያልበለጠ የአድራሻ ማረጋገጫ፣ Employment ID ወይም Letter፣ ለማይበሔራዊያን ተፈጻሚ ከሆነ work permit እና ሁለት የቅርብ ጊዜ passport-size ፎቶዎች ናቸው። ለተለየ መመሪያ Premier Bankን ያነጋግሩ።",
  },
  zh: {
    ...
    open: "开设 Personal Current Account 时，网站列出的资料包括：National ID 或 Passport、作为补充身份证明的 Driver's License、三个月内的地址证明、Employment ID 或 Letter、非公民适用时的 work permit，以及两张近期 passport-size 照片。如需针对您账户的指导，请联系 Premier Bank。",
  },
  tr: {
    ...
    open: "Personal Current Account açmak için web sitesi şu belgeleri listeler: National ID veya Passport, ek kimlik olarak Driver's License, üç aydan eski olmayan adres kanıtı, Employment ID veya Letter, vatandaş olmayanlar için geçerliyse work permit ve iki yeni passport-size fotoğraf. Hesabınıza özel yönlendirme için lütfen Premier Bank ile iletişime geçin.",
  },
};
...
const accountOpeningTranslations: Record<ChatLanguage, string> = {
  so: "Si aad u furato Personal Current Account, diyaari National ID ama Passport, Driver's License oo aqoonsi dheeraad ah, caddeynta cinwaanka oo aan ka weynayn saddex bilood, Employment ID ama Letter, work permit haddii ay khusayso, iyo laba sawir oo passport-size ah. Wixii hagid gaar ah, fadlan nala soo xiriir.",
  en: "To open a Personal Current Account, prepare a National ID or Passport, a Driver's License as additional identification, proof of address not older than three months, an Employment ID or Letter, a work permit where applicable, and two recent passport-size photos. For account-specific guidance, please contact us.",
  sw: "Ili kufungua Personal Current Account, andaa National ID au Passport, Driver's License kama kitambulisho cha ziada, uthibitisho wa anwani usiozidi miezi mitatu, Employment ID au Letter, work permit inapohitajika, na picha mbili za passport-size za karibuni. Kwa mwongozo zaidi, tafadhali wasiliana nasi.",
  am: "Personal Current Account ለመክፈት National ID ወይም Passport፣ ተጨማሪ መታወቂያ እንደ Driver's License፣ ከሦስት ወር ያልበለጠ የአድራሻ ማረጋገጫ፣ Employment ID ወይም Letter፣ ተገቢ ሲሆን work permit እና ሁለት የቅርብ ጊዜ passport-size ፎቶዎች ያዘጋጁ። ለተጨማሪ መመሪያ እባክዎ ያነጋግሩን።",
  zh: "开设 Personal Current Account 时，请准备 National ID 或 Passport、作为补充身份证明的 Driver's License、三个月内的地址证明、Employment ID 或 Letter、适用时的 work permit，以及两张近期 passport-size 照片。如需更多指引，请联系我们。",
  tr: "Personal Current Account açmak için National ID veya Passport, ek kimlik olarak Driver's License, üç aydan eski olmayan adres kanıtı, Employment ID veya Letter, gerektiğinde work permit ve iki yeni passport-size fotoğraf hazırlayın. Daha fazla yönlendirme için lütfen bizimle iletişime geçin.",
};
...
function isWalletTransferQuestion(question: string) {
  return !isWalletSendQuestion(question) && isWalletQuestion(question) && includesAny(question, ["send money", "send", "dir", "transfer", "lacag uga dira", "lacag u dira", "wallet to wallet", "qr code", "contact information", "bank account", "unregistered", "tuma pesa", "gönder", "转账", "发送"]);
}
...
const expandedServiceAnswers: Record<"so" | "en", { walletDownload: string; walletRegistration: string; walletBill: string; walletTopUp: string; walletTransfer: string; walletWithdrawal: string; walletExchange: string; walletTvBill: string; walletEducationBill: string; paymentGateway: string; jabaneAtm: string; cashDeposit: string }> = {
  so: {
    walletDownload: "Haa, Premier Wallet app waa la heli karaa. Google Play: https://swiy.co/premierwallet — App Store: https://hi.switchy.io/premierwallet",
    ...
    walletTransfer: "Premier Wallet waxaad uga diri kartaa lacag Wallet user kale adigoo adeegsanaya QR code ama contact information, bank account, iyo xaaladaha la taageero qof aan weli Wallet iska diiwaan gelin. Fur app-ka, dooro Send Money, dooro habka transfer-ka, geli lacagta, kadibna xaqiiji gudaha app-ka PIN-kaaga gaarka ah. Ha la wadaagin PIN-kaaga cidna.",
  ...
  en: {
    walletDownload: "Yes, Premier Wallet is available. Google Play: https://swiy.co/premierwallet — App Store: https://hi.switchy.io/premierwallet",
    ...
    walletTransfer: "With Premier Wallet, you can send money to another Wallet user using a QR code or contact information, to a bank account, and in supported cases to an unregistered Wallet recipient. Open the app, choose Send Money, select the transfer method, enter the amount, then confirm inside the app with your private PIN. Never share your PIN with anyone.",
...
const walletTrainingAnswers: Record<"so" | "en", {
  ...
  so: {
    ...
    profilePhoto: "Habka profile picture loogu daro Premier Wallet kuma jiro xogta la xaqiijiyay ee aan hadda hayo. Fadlan ka hubi Profile ama Settings gudaha app-ka, ama la xiriir Premier Bank.",
    ...
    bankToWallet: "Waxaan xaqiijin karaa Wallet-to-Bank transfer, balse tallaabooyinka saxda ah ee Bank Account ilaa Wallet kuma jiro xogta la xaqiijiyay ee aan hadda hayo. Fadlan ka hubi Premier Wallet ama Premier Bank.",
    walletToBank: "Haa, Premier Wallet wuxuu taageeraa Wallet-to-Bank Account transfer meelaha adeegga laga taageero. Hubi faahfaahinta koontada qaataha ka hor xaqiijinta; habka saxda ah ee menu-ga iyo khidmadaha fadlan ka hubi app-ka ama Premier Bank.",
  ...
  en: {
    ...
    profilePhoto: "I do not have verified steps for adding a profile picture in Premier Wallet. Please check Profile or Settings in the app, or contact Premier Bank.",
    ...
    bankToWallet: "Wallet-to-Bank transfer is verified, but I do not have verified steps for Bank Account to Wallet. Please check Premier Wallet or contact Premier Bank.",
    walletToBank: "Yes, Premier Wallet supports Wallet-to-Bank Account transfers where the service is available. Check the recipient account details before confirming; please verify the exact menu steps and any fees in the app or with Premier Bank.",
...
const additionalCommunityAnswers: Record<"so" | "en", {
  ...
  so: {
    ...
    walletExtended: "Premier Wallet wuxuu taageeraa adeegyada la heli karo sida lacag-bixinta biyaha, waxbarashada, TV/Cable iyo caafimaadka; Wallet-to-Wallet iyo Wallet-to-Bank transfers; lacag u dirid qof aan Wallet lahayn; QR code ama Merchant ID payments; airtime top-up; currency exchange; iyo transaction history. Khidmadaha, xuduudaha iyo adeeg-bixiyeyaasha la taageero fadlan xaqiiji ka hor isticmaalka.",
  ...
  en: {
    ...
    walletExtended: "Premier Wallet supports eligible water, education, TV/Cable and healthcare payments; Wallet-to-Wallet and Wallet-to-Bank transfers; sending to a recipient without a Wallet; QR code or Merchant ID payments; airtime top-up; currency exchange; and transaction history. Please confirm fees, limits and supported providers before use.",
