...
import { ChevronDown, Globe2, Mic, Send, Sparkles, X } from "lucide-react";
  ...
  return <aside className={`premier-chatbot${isDark ? " is-dark" : ""}${open ? " is-open" : ""}`} aria-label="Premier Bank digital assistant">
    {open && <section className="premier-chat-window" aria-label="Chat with Premier Bank">
      <header className="premier-chat-header">
        <div className="premier-chat-brand"><span><Sparkles className="premier-chat-brand-icon" size={23} aria-hidden="true" /></span><div><b>Premier Bank Assistant</b><small><i />Online - Informational support</small></div></div>
